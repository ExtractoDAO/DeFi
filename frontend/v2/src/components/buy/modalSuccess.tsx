...
export default function ModalSuccess({ open, handleClose }: ModalProps) {
    return (
                            ...
                            >
                                        ...
                                        >
                                            ...
                                            <div className="mt-2">
                                                ...
                                                >
                                                    ...
                                                    of your transaction on
                                                    Polygon Scan. After
                                                    completing the transaction,
                                                    your contract will be listed
                                                    in the Drawer.
                                                </p>
                                            </div>
                                        </div>
                                ...
                                >
                                    <Button
                                        ...
                                        onClick={() => handleClose()}
                                    >
                                        Close and wait in plolygon scan
                                    </Button>
                                </div>
                            </Dialog.Panel>
                        </Transition.Child>
